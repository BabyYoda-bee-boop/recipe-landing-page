...
### Screenshot
<div style="display:flex; gap:8px; align-items:flex-start; width:100%; max-width:900px;">
  <div style="width:400px; overflow:auto; border:1px solid #e6e6e6;">
    <h2>Desktop version:</h2>
    <img src="./screenshot.png" alt="Desktop screenshot" style="display:block; width:100%; height:auto;">
  </div>

  <div style="width:400px; max-height:800px; overflow:auto; border:1px solid #e6e6e6;">
    <h2>Mobile version (375px):</h2>
    <img src="./screenshot-375-mobile.png" alt="Mobile screenshot" style="display:block; width:100%; height:auto;">
  </div>
</div>
